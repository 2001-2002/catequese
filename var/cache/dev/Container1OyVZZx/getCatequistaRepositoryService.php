...
// Returns the private 'App\Repository\CatequistaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatequistaRepository.php';

return $this->privates['App\Repository\CatequistaRepository'] = new \App\Repository\CatequistaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
