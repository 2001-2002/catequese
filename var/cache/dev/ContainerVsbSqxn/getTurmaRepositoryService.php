...
// Returns the private 'App\Repository\TurmaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TurmaRepository.php';

return $this->privates['App\Repository\TurmaRepository'] = new \App\Repository\TurmaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
