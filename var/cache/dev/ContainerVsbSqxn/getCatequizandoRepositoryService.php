...
// Returns the private 'App\Repository\CatequizandoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CatequizandoRepository.php';

return $this->privates['App\Repository\CatequizandoRepository'] = new \App\Repository\CatequizandoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
