...
// Returns the private 'App\Repository\PendenciasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PendenciasRepository.php';

return $this->privates['App\Repository\PendenciasRepository'] = new \App\Repository\PendenciasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
