...
// Returns the private 'App\Repository\EscolaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EscolaRepository.php';

return $this->privates['App\Repository\EscolaRepository'] = new \App\Repository\EscolaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
